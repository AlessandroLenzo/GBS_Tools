...
namespace CAST
{
    public class RequestHandler
    {
        ...
        private string log_file_name, aip_log_file_name;
        private string castExePath, castLogPath, castSrcPath, castBaselineSrcPath, castDBServer;
        ...
        public RequestHandler(CASTRequestType request)
        {
            ...
            castExePath = ConfigurationManager.AppSettings["CASTAIP_Path"];
            ...
            aip_log_file_name = castLogPath + "\\snapshot_" + req.APP + "_" + req.IDR + ".txt";
            ...
            listener.WriteLine("CASTAIP_Path=" + castExePath);
        ...
        public bool ValidateRequest(CASTResponseType res)
        {
            ...
            try
            {
                ...
                else if (req.TAT == null || req.TAT == string.Empty || !(req.TAT == "QCH" || req.TAT == "COF" || req.TAT == "IMP"))
                {
                    res.CODICE = "KO";
                    res.MESSAGGIO = "invalid request field TAT (valid values: QCH, COF, IMP)";
                    ret = false;
                }
                ...
                else if (req.TAT == "QCH" && (req.VPR == null || req.VPR == string.Empty || !(req.VPR == "V" || req.VPR == "N")))
                {
                    res.CODICE = "KO";
                ...
                else if (req.MAT == "B" && (req.VBS == null || req.VBS == string.Empty))   //controllare anche esistenza snapshot baseline
                {
                    res.CODICE = "KO";
                ...
                else
                {
                    ...
                    if (app.CMSProfile == null || app.CMSProfile == string.Empty)
                    {
                        res.CODICE = "KO";
                    ...
                    else if (req.MAT == "B" && (prodApp = QPMDatabaseHelper.ReadApp(QPMDbConnStr, req.APP, "1", "0")) == null)
                    {
                        res.CODICE = "KO";
        ...
        public void ThreadProc()
        {
            ...
            try
            {
                ...
                {
                    case "COF":
                        ConsolidamentoMetriche(req,app);
                        break;
        ...
        public void ConsolidamentoMetriche(CASTRequestType req, GBSApplication app)
        {
        ...
        public void QualityCheck(CASTRequestType req, GBSApplication app)
        {
            ...
            if (req.MAT == "B")
            {
                ...
                ExcelReportHelper.BuildReport(req, new_violations, removed_violations, message, result.pathFile, files_num, obj_num, prod_count, prod_golden_count, baseline_version);
        ...
        public void RunAnalysis(GBSApplication app, string logFilePath)
        {
            ...
            string executableName = castExePath + "\\CAST-MS-cli.exe";
        ...
        public bool GenerateSnapshot(GBSApplication app, CASTRequestType req)
        {
            ...
            string executableName = castExePath + "\\CAST-MS-cli.exe";
            string executableParameter = "GenerateSnapshot -connectionProfile \"" + app.CMSProfile +
                                         "\" -deliveryUnit \"" + app.CMSDeliveryUnit +
                                         "\" -appli \"" + app.Name +
                                         "\" -logFilePath \"" + aip_log_file_name +
                                         "\" -snapshot \"" + req.SNN +
        ...
        { 
            ...
            using (FileStream file = new FileStream(aip_log_file_name, FileMode.Open, FileAccess.Read, FileShare.ReadWrite))
            {
